...
package net.mcreator.firstmodyay.block;
...
public class CopperOreBlock extends FIRSTMODYAYElements.ModElement {
	@ObjectHolder("firstmodyay:copperore")
	public static final Block block = null;
	public CopperOreBlock(FIRSTMODYAYElements instance) {
		super(instance, 4);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(MyModItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 32), Placement.COUNT_RANGE, new CountRangeConfig(32, 63, 63, 90)));
		}
	}
}
